...
export const AddOrder = ({ products }: TAddOrderProps) => {
	...
	const handleAutoGenerated = (event: React.ChangeEvent<HTMLInputElement>) => {
		setIsAutoGenerated(event.target.checked);
	};
			...
			<Card.Body>
				...
				<FormProvider {...form}>
					...
					>
						<Form.Check
							type='checkbox'
							label={t('Automatic title generation')}
							checked={!!isAutoGenerated}
							onChange={handleAutoGenerated}
						/>
